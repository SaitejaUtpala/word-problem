...
# (1). removed args.dim_ffn = int((args.n_embd * 3.5) // 32 * 32) and dim_ffn is part of the input argument. 
# (2).
...
class RWKVSequenceClassifier(RWKV):
    """An RWKV with a linear classifier head."""
