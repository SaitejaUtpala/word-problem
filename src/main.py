...
from sfirah.s4 import S4TokenClassifier
from sfirah.ids4 import IDS4TokenClassifier
...
def train_s4(
    ...
    log_level: str = "INFO",
    seed: int = randint(0, 2**32 - 1),
    project_name: str = "word_problem_s4",
    logging: bool = True,
):
    """Train Mamba model."""
    set_seed(seed)
    ...
    if tagging:
        ...
        raise NotImplementedError("S4 only support Tagging")
...
def train_ids4(
    ...
    log_level: str = "INFO",
    seed: int = randint(0, 2**32 - 1),
    project_name: str = "word_problem_ids4",
    logging: bool = True,
):
    """Train Mamba model."""
    set_seed(seed)
    ...
    if tagging:
        ...
        raise NotImplementedError("IDS4 only support Tagging")
